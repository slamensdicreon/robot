...
# --- Pin setup (moved to avoid Pico Display Pack conflicts) ---
# Display uses GP10-20, so sensors moved to free pins:
#   PIR:      GP16 → GP22
#   US TRIG:  GP14 → GP26
#   US ECHO:  GP15 → GP27
...
def poll_ultrasonic():
    ...
    (1k + 2k) to step down to 3.3V before connecting to GP27.
    """
    trig_pin.value(0)
    time.sleep_us(5)
    trig_pin.value(1)
